...
export const FR = {
  ...
  "coop.presence.label": "Joueurs connectés",
  "coop.presence.joined": "A REJOINT LA SESSION",
  "coop.presence.left": "A QUITTÉ LA SESSION",
  "coop.presence.hostMark": "H",
  "coop.presence.host": "HÔTE",
  "coop.presence.you": "VOUS",
  "coop.upgrade.hostVerified": "XP VÉRIF. PAR L'HÔTE",
  "coop.upgrade.hostOnly": "VÉRIF. HÔTE",
  "coop.upgrade.guestReason": "Ce miroir invité ne reçoit pas l'XP des tours ; les améliorations doivent être faites par l'hôte.",
  "coop.end.title": "TERMINER LA CO-OP ?",
  "coop.end.subtitle": "Cela termine la session pour tous les joueurs.",
  "coop.end.action": "TERMINER LA SESSION",
  "coop.ended.title": "L'HÔTE EST PARTI",
  "coop.ended.subtitle": "L'hôte a terminé la session. Cette bataille en co-op est finie.",
