...
export const FR = {
  ...
  "result.endlessSubtitle": "{name} ENDLESS &mdash; vague {w} atteinte",
  "result.newBest": " &middot; NOUVEAU RECORD !",
  "result.bestWave": " &middot; meilleure vague {w}",
  ...
  "result.forfeitSubtitle": "Tu retourneras au menu principal et cette bataille s'arrête là &mdash; pas de victoire, pas de crédit de complétion. Tes tourelles gardent l'XP gagnée jusqu'ici.",
  "result.forfeit": "ABANDONNER",
  "result.forfeitNote": "Tu as abandonné &mdash; pas de victoire ni de crédit de complétion. Les tourelles ont gardé l'XP et les éclats gagnés.",
  "result.stashOverflowNote.one": "Réserve pleine &mdash; {n} objet n'a pas pu être stocké. Gère ton équipement pour faire de la place.",
  "result.stashOverflowNote.many": "Réserve pleine &mdash; {n} objets n'ont pas pu être stockés. Gère ton équipement pour faire de la place.",
